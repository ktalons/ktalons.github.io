...
> EliteDesk 800 G4 Mini I own outright, and I committed to docker-compose. The full
...
From the firewall side, the host's last outbound traffic was on May 29 (normal Proxmox repo and update calls), then nothing. No ARP entry for it on the lab VLAN since. So it dropped off the wire entirely. This wasn't a service crash or a misconfiguration.
