...
- **DLQ Watcher**: monitors the Logstash Dead Letter Queue and surfaces parse and pipeline failures before they pile up silently. See [`DLQ-WATCHER-README.md`](https://github.com/ktalons/IAESsoc-elk-snapshot/blob/main/DLQ-WATCHER-README.md).
